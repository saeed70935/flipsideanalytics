...
export default function TopDestinations({ className, options, height, CurrentTimeSpan }: Props) {
    const Result: FlipsideResponse = useFlipside(Queries.AirDrop.TopDestinations);
    //@ts-ignore
