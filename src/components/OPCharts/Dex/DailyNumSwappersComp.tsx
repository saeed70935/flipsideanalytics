...
export default function DailyNumSwappersComp({ className, height, CurrentTimeSpan ,QueryResult }: Props) {
    // const ModifiedQuery = useQueryWithTimeSpan(Queries.OverView.DistributionByNumTransactions, CurrentTimeSpan)
    const chartdatatemp = useGroupedChartData(1, 4, 0, QueryResult.QueryResult, VerticalSettings2.datasets);
